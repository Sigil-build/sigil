...
internal static class StringsEmitter
{
    public static string Emit(IReadOnlyList<CatalogFile> files)
    {
        ...
        // ADR-016: emitted source never reaches IDE0073, so the licence header
        // is written here or it does not exist on this file at all.
        sb.AppendLine("// Copyright (c) 2026 Yevhen Khudoliiv. All rights reserved.");
        sb.AppendLine("// Licensed under the Sigil License 1.0. See LICENSE in the repository root.");
