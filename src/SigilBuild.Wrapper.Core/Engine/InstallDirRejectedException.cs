...
/// directory falls outside the scope root (R3).
/// </summary>
/// <remarks>
/// <para>
/// <c>/D=</c> sets <c>install_dir</c> to any path the caller names, and
/// <c>{install_dir}</c> substitutes into
/// <c>scheduled_task_create.program</c> and <c>service_install.binary_path</c> —
/// both of which run as SYSTEM. Unchecked, <c>Setup.exe /allusers /D=C:\Users\Public\evil</c>
/// creates a SYSTEM-level task pointing at a directory any user can
