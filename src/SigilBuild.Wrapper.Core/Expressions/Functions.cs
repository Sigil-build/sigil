...
/// first — see <c>docs/architecture/adr-008-expression-policy.md</c> §1
/// (closed function catalog + admission criteria). Every data-retrieval
/// function returns <c>""</c> on the absent/denied path rather than throwing
/// (total).
/// </summary>
